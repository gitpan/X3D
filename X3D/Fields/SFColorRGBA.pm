...
sub STORE {
	...
	return $this->setAngle(shift) if $key == 3;
}
...
my $v1 = new SFColorRGBA(.1,.2,.3);
my $v2 = new SFColorRGBA(.2,.3,.4);
$v1->setHSV( $v1->getHSV );
...
timethis (1000000, sub { my $v = new SFColorRGBA });
...
my $translation0 = new SFColorRGBA();
my $translation1 = new SFColorRGBA(1,2,3);
