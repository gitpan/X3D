...
sub STORE {
	...
	return $this->setZ(shift) if $key == 2;
}
...
sub toString {
	my ($this) = @_;
	return join $X3DGenerator::SPACE, map { ( sprintf $X3DGenerator::DOUBLE, $_ ) + 0 } $this->getValue;
}
...
my $v1 = new SFVec2d(1,2);
my $v2 = new SFVec2d(2,3);
...
timethis (1000000, sub { my $v = new SFVec2d });
...
my $v1 = new SFVec2d(1,2,3);
my $v2 = new SFVec2d(2,3,4);
timethis (1000000, sub { my $v = new SFVec2d });
timethis (1000000, sub { my $v = $v1 + $v2 });
...
my $translation0 = new SFVec2d();
my $translation1 = new SFVec2d(1,2,3);
