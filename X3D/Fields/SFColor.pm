...
sub FETCH {
	my $this = shift;
	my $key  = shift;
	return $this->setRed   if $key == 0;
	return $this->setGreen if $key == 1;
	return $this->setBlue  if $key == 2;
}
...
my $v1 = new SFColor(.1,.2,.3);
my $v2 = new SFColor(.2,.3,.4);
$v1->setHSV( $v1->getHSV );
...
timethis (1000000, sub { my $v = new SFColor });
...
my $translation0 = new SFColor();
my $translation1 = new SFColor(1,2,3);
